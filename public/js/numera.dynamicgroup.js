    ...
    $.addDynamicGroup = function(element, options) {
        var dg = {
            ...
            createTable: function() {
                ...
                dg.root.append('<div id="addContainer" class="formRow"><div class="formElement"><input type="button" value="Add schedule" class="groupAdd" /></div></div>')
            ...
            getFormValues: function() {
                ...
                for (i in row) {
                    if (dg.columns[i].required && !row[i]) {
                        dg.columns[i].element.append('<ul class="errors"><li>Required field</li></ul>').parent().addClass('formError');
                        return false;
                    }
                }
                return row;
