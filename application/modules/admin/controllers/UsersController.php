...
class Admin_UsersController extends HandsOn_Controller_Action {
    ...
    public function userhistoryAction() {
        ...
        $config['group'][1]['data'] = array(array(
                        'type' => 'table',
                        'header' => array('Hora', 'Name', 'Quantidade',
    ...
    public function userhistorypdfAction() {
        ...
        $page->drawText('Name', 140 ,650, 'UTF-8');
        $page->drawText('Alerts.', 240, 650);
        ...
        $page->drawText('Name', 110 ,$line, 'UTF-8');
        $page->drawText('Alerts.', 180, $line);
